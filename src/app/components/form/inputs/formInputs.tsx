        ...
        <>
          <div className="grid custom-grid-form gap-x-8 gap-y-3 w-full">
            ...
            <div className="flex flex-col-reverse gap-[2px]">
              <input value={formData.id?.toString() || ''} onChange={(e) => handleInput(e, "id")} min="1" type="number" name="id" id="id" placeholder='Ingresa el ID' className={`${idError ? 'error-input' : ''} personalized-text-input dark:bg-transparent ${!formData ? 'bg-white' : `${formData.id !== originalFormData?.id ? 'bg-gray-200 dark:bg-gray-700' : 'bg-white'}`}`} />
            ...
            <div className="flex flex-col-reverse gap-1 w-full">
              <input value={formData.p_surname?.toString() || ''} type="text" name="p_surname" id="p_surname" onChange={(e) => handleInput(e, "p_surname")} placeholder='Ingresa el apellido paterno' className={`personalized-text-input dark:bg-transparent ${!formData ? 'bg-white' : `${formData.p_surname !== originalFormData?.p_surname ? 'bg-gray-200 dark:bg-gray-700' : 'bg-white'}`}`} />
            ...
            {/* APELLIDO MATERNO */}
            <div className="flex flex-col-reverse gap-1 w-full">
              <input value={formData.m_surname?.toString() || ''} type="text" name="m_surname" id="m_surname" onChange={(e) => handleInput(e, "m_surname")} placeholder='Ingresa el apellido materno' className={`personalized-text-input dark:bg-transparent ${!formData ? 'bg-white' : `${formData.m_surname !== originalFormData?.m_surname ? 'bg-gray-200 dark:bg-gray-700' : 'bg-white'}`}`} />
            ...
            {/* NOMBRE */}
            <div className="flex flex-col-reverse gap-1 w-full">
              <input value={formData.name?.toString() || ''} type="text" name="name" id="name" onChange={(e) => handleInput(e, "name")} placeholder='Ingresa el nombre' className={`personalized-text-input dark:bg-transparent ${!formData ? 'bg-white' : `${formData.name !== originalFormData?.name ? 'bg-gray-200 dark:bg-gray-700' : 'bg-white'}`}`} />
            ...
            {/* EDAD */}
            <div className="flex flex-col-reverse gap-1 w-full">
              <input value={formData.age?.toString() || ''} type="number" name="age" id="age" min="1" onChange={(e) => handleInput(e, "age")} onKeyDown={preventInvalidChars} placeholder='Ingresa la edad del participante' className={`personalized-text-input dark:bg-transparent ${!formData ? 'bg-white' : `${formData.age !== originalFormData?.age ? 'bg-gray-200 dark:bg-gray-700' : 'bg-white'}`}`} />
            ...
            {/* CATEGORÍA */}
            <div className="flex flex-col-reverse gap-1 w-full">
              <input value={formData.category?.toString() || ''} type="text" name="category" id="category" onChange={(e) => handleInput(e, "category")} placeholder='Ingresa la categoría del participante' className={`personalized-text-input dark:bg-transparent ${!formData ? 'bg-white' : `${formData.category !== originalFormData?.category ? 'bg-gray-200 dark:bg-gray-700' : 'bg-white'}`}`} />
          ...
          {activeSection === "Datos Corporales" ?
            <>
              <div className="grid custom-grid-form gap-x-8 gap-y-3 w-full">
                ...
                {/* FFM */}
                <div className="flex flex-col-reverse gap-1 w-full">
                  <input value={formData.ffm?.toString() || ''} type="number" name="ffm" id="ffm" min="0" onChange={(e) => handleInput(e, "ffm")} onKeyDown={preventInvalidChars} placeholder='Ingresa la masa libre de grasa' className={`personalized-text-input dark:bg-transparent ${!formData ? 'bg-white' : `${formData.ffm !== originalFormData?.ffm ? 'bg-gray-200 dark:bg-gray-700' : 'bg-white'}`}`} />
                  <label htmlFor="ffm" className='pb-[2px] text-base text-gray-800 dark:text-gray-100 font-medium label-default'>FFM</label>
                </div>
                {/* TBW */}
                <div className="flex flex-col-reverse gap-1 w-full">
                  <input value={formData.tbw?.toString() || ''} type="number" name="tbw" id="tbw" min="0" onChange={(e) => handleInput(e, "tbw")} onKeyDown={preventInvalidChars} placeholder='Ingresa el agua corporal total' className={`personalized-text-input dark:bg-transparent ${!formData ? 'bg-white' : `${formData.tbw !== originalFormData?.tbw ? 'bg-gray-200 dark:bg-gray-700' : 'bg-white'}`}`} />
                  ...
                  <>
                    <div className="grid custom-grid-form_rendimiento gap-y-3 w-full">
                      <div className="grid gap-x-8 gap-y-2 custom-grid-form_rendimiento-sections">
                        {/* GRIP */}
                        <div className="flex flex-col-reverse gap-1 w-full">
                          <input value={formData.grip?.toString() || ''} type="number" name="grip" id="grip" min="0" onChange={(e) => handleInput(e, "grip")} onKeyDown={preventInvalidChars} placeholder='Ingresa el agarre' className={`personalized-text-input dark:bg-transparent ${!formData ? 'bg-white' : `${formData.grip !== originalFormData?.grip ? 'bg-gray-200 dark:bg-gray-700' : 'bg-white'}`}`} />
                      ...
                      <div className="grid gap-x-8 gap-y-1 custom-grid-form_rendimiento-sections">
                        {/* RESISTANCE*/}
                        <div className="flex flex-col-reverse gap-1 w-full">
                          <input value={formData.resistance?.toString() || ''} type="text" name="resistance" id="resistance" min="0" onChange={(e) => handleInput(e, "resistance")} onKeyDown={preventInvalidChars} placeholder='Ingresa el tiempo' className={`personalized-text-input dark:bg-transparent ${!formData ? 'bg-white' : `${formData.resistance !== originalFormData?.resistance ? 'bg-gray-200 dark:bg-gray-700' : 'bg-white'}`}`} />
                          <label htmlFor="p" className='pb-[2px] text-base text-gray-800 dark:text-gray-100 font-medium label-default'>Resistencia</label>
                        </div>
                        {/* RESISTANCE POINTS*/}
                        <div className="flex flex-col-reverse gap-1 w-full">
                          <input value={formData.resistance_points?.toString() || ''} type="number" name="resistance_points" id="resistance_points" min="0" onChange={(e) => handleInput(e, "resistance_points")} onKeyDown={preventInvalidChars} placeholder='Puntos por tiempo' className={`personalized-text-input dark:bg-transparent ${!formData ? 'bg-white' : `${formData.resistance_points !== originalFormData?.resistance_points ? 'bg-gray-200 dark:bg-gray-700' : 'bg-white'}`}`} />
                          <label htmlFor="p" className='pb-[2px] text-base text-gray-800 dark:text-gray-100 font-medium label-default'>Puntos</label>
                        </div>
                      </div>
                    </div>
