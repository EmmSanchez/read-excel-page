...
export function DeleteButton ({handleGetRow, rowIndex, rowToDelete, cancelDelete, confirmDeleteRow}: DeleteButtonProps) {
  return (
    <>
      <button className='w-[24px] h-full rounded-md transition-all hover:bg-zinc-50 dark:hover:bg-gray-700' onClick={(e) => {e.stopPropagation(); handleGetRow(rowIndex, 'delete')}}>
